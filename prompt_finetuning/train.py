...
#     prompt_question3 = "tell me more about yourself."
    ...
    """ data loading """
    if data_type == 'personachat':
        train_path = "/data/project/rw/rung/source/dataset/persona_dialog/personachat/train_both_" + persona_type + ".json"
        dev_path = "/data/project/rw/rung/source/dataset/persona_dialog/personachat/valid_both_" + persona_type + ".json"
        test_path = "/data/project/rw/rung/source/dataset/persona_dialog/personachat/test_both_" + persona_type + ".json"
    else:
